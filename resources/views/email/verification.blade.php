            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="80%"
                ...
                <tr>
                    <td class="bg_white logo" style="padding: 1em 2.5em; text-align: center">
                        <h1><a href="#">Les NaCCyS</a></h1>
                    </td>
                </tr><!-- end tr -->
                <tr>
                    <td valign="middle" class="hero"
                        style="background-image: url(https://apisagec.nunua.markets/api_sagec/public/uploads/favicon.png); background-size: cover; height: 200px;">
                        <table>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td class="bg_dark email-section" style="text-align:center;">
                                    <div class="heading-section heading-section-white">
                                      ...
                                      <p><a class="btn btn-primary"> {{ $code }}</a></p>
                                    </div>
                                </td>
                            </tr><!-- end: tr -->
                        </table>
